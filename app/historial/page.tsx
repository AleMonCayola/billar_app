  ...
  return (
    <AppShell title="Historial mesa">
      <p className="text-ink-muted mb-5 text-sm">
        Total histórico acumulado desde que se usa el sistema.
      </p>
      ...
      <div className="mt-5 p-5 rounded-xl bg-cloth/10 border border-cloth/40 flex justify-between items-center">
